...
Environs also supports reading a hidden file called `.env` in the root of the project, rather that exporting variables at the user level, they can be defined at a project level. Just remember never to include `.env` in version control!
